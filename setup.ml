...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0af4419eef44b157ff56496923c15349) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("react",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_react", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("preemptive",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_preemptive", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("ppx",
     ...
     package =
       {
          ...
          sections =
            [
               Flag
                 ({
                     cs_name = "android_target";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Compiles for Android";
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "unix",
                                OASISExpr.ENot
                                  (OASISExpr.EFlag "android_target")),
                             true)
                        ]
                   });
               Flag
               ...
               Flag
                 ({
                     cs_name = "libev_default";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Use the libev backend by default";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lwt_tracing"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lwt";
                      lib_findlib_name = Some "tracing";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lwt_log_core"; "Lwt_log_rules"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lwt";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Lwt_unix_jobs_generated"; "Lwt_config"];
                      lib_findlib_parent = Some "lwt";
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "ppx", OASISExpr.EFlag "all"),
                             true)
                        ];
                      bs_install =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_lwt_ex.ml"});
               Doc
                 ({
                     cs_name = "lwt-manual";
                     cs_data = PropList.Data.create ();
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_preemptive"
                        ]
                   });
               Test
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\190\193\218Vk\252I\2415~\186\177\2195\143\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
