...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28db97d91accf449dc5818ccdd88eda7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/core";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lwt-tracing"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Lwt_unix_jobs_generated"];
                      lib_findlib_parent = Some "lwt";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\153\025P}ML\132\255#-\158\160c\127L\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
